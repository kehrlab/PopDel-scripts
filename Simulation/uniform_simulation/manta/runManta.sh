...
/usr/bin/time -f "400\t%e\t%U\t%S\t%M" -ao time/manta.time manta/0400.manta.sh
/usr/bin/time -f "500\t%e\t%U\t%S\t%M" -ao time/manta.time manta/0500.manta.sh
/usr/bin/time -f "600\t%e\t%U\t%S\t%M" -ao time/manta.time manta/0600.manta.sh
/usr/bin/time -f "700\t%e\t%U\t%S\t%M" -ao time/manta.time manta/0700.manta.sh
/usr/bin/time -f "800\t%e\t%U\t%S\t%M" -ao time/manta.time manta/0800.manta.sh
/usr/bin/time -f "900\t%e\t%U\t%S\t%M" -ao time/manta.time manta/0900.manta.sh
/usr/bin/time -f "1000\t%e\t%U\t%S\t%M" -ao time/manta.time manta/1000.manta.sh
